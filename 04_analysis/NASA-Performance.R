...
(Successmeansd = ggplot(summary_QuestExp2, aes(x = Timepoint, y = mean_Success, group = Scenario, colour = Scenario))+ #summary_QuestExp2[!is_outlier(summary_QuestExp2$mean_Success, coef= 1.5)]
  geom_line(aes(x = Timepoint, y = mean_Success))+
